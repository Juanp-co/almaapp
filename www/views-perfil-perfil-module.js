    ...
    getData() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            if (data && !data.error) {
                ...
                this.userData.birthday = this.userData.birthday ? dayjs__WEBPACK_IMPORTED_MODULE_5___default()(this.userData.birthday).format('DD-MM-YYYY') : null;
